...
<!-- 								
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysql_query("insert into teacher (firstname,lastname,username,password,location,about,department_id,teacher_status,teacher_stat)
								values ('$firstname','$lastname','$lastname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','','$department_id','Registered','Activated')         
								") or die(mysql_error()); ?>
								<script>
