		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										mysql_query("insert into subject (subject_code,subject_title,description,unit,semester, category,Pre_req) values('$subject_code','$title','$description','$unit','$semester','null','null')")or die(mysql_error());
