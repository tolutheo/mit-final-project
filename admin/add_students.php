								...
								<form id="add_student" method="post">
								        ...
								        <div class="control-group">
                                          ...
                                          <div class="controls">
											...
											?>
											<option value="<?php echo $cys_row['class_id']; ?>" placeholder = "Select Class"><?php echo $cys_row['class_name']; ?></option>
											<?php } ?>
                                            </select>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="save" class="btn btn-info" type="submit"><i class="icon-plus-sign icon-large"></i></button>
...
mysql_query("insert into student (username,firstname,lastname,location,class_id,status) values ('$un','$fn','$ln','uploads/NO-IMAGE-AVAILABLE.jpg','$class_id','Unregistered')") or die(mysql_error());
*/
